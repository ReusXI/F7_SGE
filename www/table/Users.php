            ...
            <div class="modal-content">
                <form action="Users.jsp">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" name="btn_guardar" class="btn btn-success" value="Agregar">
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="Users.jsp">
                    ...
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
                        <input name="btn_editar" type="submit" class="btn btn-info" value="Guardar">
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="Users.jsp">
                    ...
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
                        <input type="submit" class="btn btn-danger" name="btn_eliminar" value="Eliminar">
                    </div>
                </form>
            </div>
        </div>
