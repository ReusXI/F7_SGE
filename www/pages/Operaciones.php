...
if (isset($_GET['inp_guardar']) != null) {
  ...
  if($_GET['rt_afectado'] == 'OTRO O VARIOS'){
    $recursos_tecno = $_GET['r_t_afectados']; 
  }else{
    $recursos_tecno = $_GET['rt_afectado'];
  }
  
    $sql_leer = "CALL INSERTAR_EVENTO('" . $_GET['t_institucion'] . "','" . $_GET['c_institucion'] . "','" . $_GET['asunto'] . "','" . $_GET['f_incidente'] . "','" . $_GET['f_deteccion'] . "','" . $_GET['descripcion'] . "','" . $recursos_tecno . "','" . $_GET['c_clasificacion1'] . "','" . $_GET['c_clasificacion2'] . "'," . $_GET['economico'] . "," . $_GET['dano'] . "," . $_GET['procesos'] . "," . $_GET['t_interrupcion'] . "," . $_GET['t_resolucion'] . ",'" . $sesion . "');";
